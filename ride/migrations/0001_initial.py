# Generated by Django 4.0.4 on 2022-08-06 15:07
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('matches', models.ManyToManyField(to='ride.ridingrequest')),
            ],
        ),
        migrations.AddField(
            model_name='ridingrequest',
            name='destination_waypoint',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='destination_waypoint', to='ride.waypoint'),
        ),
        migrations.AddField(
            model_name='ridingrequest',
            name='origin_waypoint',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='start_waypoint', to='ride.waypoint'),
        ),
        migrations.AddField(
            model_name='ridingrequest',
            name='driver',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('riding_requests', models.ManyToManyField(blank=True, to='ride.ridingrequest')),
            ],
            options={
