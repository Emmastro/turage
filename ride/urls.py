...
urlpatterns = [
    ...
    path("ride/request-near/", views.RideRequestNearView.as_view(),
         name="ride-request-near"),
    path("ride/request-near/<int:pk>/",
         views.RideRequestNearDetailView.as_view(), name="ride-request-near-detail"),
    path("ride/my-requests/", views.MyRequestsView.as_view(), name="my-requests"),
    path("ride/my-requests/<int:pk>",
         views.MyRequestsDetailView.as_view(), name="my-requests-detail"),
